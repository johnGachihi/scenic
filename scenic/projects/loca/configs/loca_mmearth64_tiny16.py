...
def get_config():
  ...
  config.dataset_configs.pp_train = (
      ...
      '|inception_crop_with_mask((96, 96), 32, 100, (12, 12), inkey=("query0", "target_mask", "target_box"), outkey=("query0", "query0_mask", "query0_box"))' +
      ''.join([f'|inception_crop_with_mask((42, 42), 5, 32, (6, 6), inkey=("query{i}", "target_mask", "target_box"), outkey=("query{i}", "query{i}_mask", "query{i}_box"))' for i in range(1, n_queries)]) +
