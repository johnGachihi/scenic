...
from util.misc import NativeScalerWithGradNormCount as NativeScaler, add_weight_decay
from util.mmearth_dataset import MMearthSen2Dataset

WANDB_API_KEY = os.getenv('WANDB_API_KEY_SAT_LOCA')
...
def get_args_parser():
    ...
    parser.add_argument('--train_path', default='/home/train_62classes.csv', type=str,
                        help='Train .csv path')
    parser.add_argument('--dataset_type', default='rgb', choices=['mmearth', 'rgb', 'temporal', 'sentinel', 'euro_sat', 'naip'],
    ...
    parser.add_argument('--local_rank', '--local-rank', default=os.getenv('LOCAL_RANK', 0), type=int)  # prev default was -1
...
def main(args):
    ...
    if args.dataset_type == "mmearth":
      dataset_train = MMearthSen2Dataset(args=args)
    else:
